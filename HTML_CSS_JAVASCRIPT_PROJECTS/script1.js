...
const eegChart = new Chart(eegCtx, {
    ...
    data: {
        ...
        datasets: [
            { label: 'Alpha', data: Array(50).fill(0), borderColor: '#FFD700', fill: false },
            { label: 'Beta', data: Array(50).fill(0), borderColor: '#00FF00', fill: false },
            { label: 'Theta', data: Array(50).fill(0), borderColor: '#1E90FF', fill: false },
            { label: 'Delta', data: Array(50).fill(0), borderColor: '#FF4500', fill: false },
        ]
    },
    options: {
        responsive: true,
